...
router.get('/fetch-all-waiting-deliveries', fetchAllWaitingToSendProducts)
router.post('/send-delivery-item-with-delivery-status', sendDeliveryItemWithDeliveryStatus)
